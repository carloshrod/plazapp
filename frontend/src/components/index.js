...
export { default as PlazaDocForm } from './forms/PlazaDocForm';
...
export { default as PlazaDocs } from './data/PlazaDocs';
export { default as StoreDocs } from './data/StoreDocs';
...
export { default as PasswordNotification } from './ui/PasswordNotification';
export { default as TermsNotification } from './ui/TermsNotification';
